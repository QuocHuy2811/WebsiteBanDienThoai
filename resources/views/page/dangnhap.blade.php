    ...
    <div class="contact-form">
        ...
        <form id="login-form" method="post" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <div class="input-group"> <!-- Wrap ở đây! -->
                    <input type="password" id="exampleInputPassword" name="exampleInputPassword" class="form-control">
                    <span style="background-color: transparent;" class="input-group-addon" id="togglePassword"> <!-- Dùng input-group-addon cho BS3 -->
